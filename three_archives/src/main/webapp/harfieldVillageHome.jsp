...
<div class="container">
	...
	<div class="row">
  			<div class="col-md-3" id="leftCol">
				...
				<div class="well" style="background-color:#D4CB90; opacity:0.8; color:black"> 
              ...
              <p>	The Harfield Village archive is a collection of artefacts comprising of images, videos, letters, statements and accounts of residents who were forcibly-removed from the Claremont suburb during the times of apartheid in South Africa .
              </p>
<hr>              
              	<h2 id="sec1">Map</h2>
              	<p>
...
<td><br>University of Cape Town<br>
31 -37 Orange Street<br>
Gardens, 8001<br>
Cape Town, South Africa<br>
Ph 021 480 7151<br>
email: jm.higgins@uct.ac.za</td>
<td>
<img src="${pageContext.request.contextPath}/images/CCALogo.png" style="width:70%">
</td>
