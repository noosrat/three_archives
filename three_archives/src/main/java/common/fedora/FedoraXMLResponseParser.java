...
/**
 * This method is used to parse the date contained in Fedora which is of the format yyyy-MM-dd HH:mm:ss.SSS into the format used within the Java {@link Date} 
 * @param fedoraDate {@link String} representation of the date from the Fedora Repository
